...
static void initialise_ui(void) {
	...
	// s_textlayer_4
	s_textlayer_4 = text_layer_create(GRect(38, 52, 87, 42));
	...
	text_layer_set_text(s_textlayer_5, "Shake to Refresh");
	...
	// s_inverterlayer_1
	s_inverterlayer_1 = inverter_layer_create(GRect(56, 103, 48, 56));
	layer_add_child(window_get_root_layer(s_window), (Layer *)s_inverterlayer_1);

	// s_inverterlayer_2
	s_inverterlayer_2 = inverter_layer_create(GRect(55, 102, 50, 58));
...
void toggle_shake(bool toggle) {
	GRect frame_1 = layer_get_frame(inverter_layer_get_layer(s_inverterlayer_1));
	GRect frame_2 = layer_get_frame(inverter_layer_get_layer(s_inverterlayer_2));
	...
	layer_set_frame(inverter_layer_get_layer(s_inverterlayer_1), frame_1);
	layer_set_frame(inverter_layer_get_layer(s_inverterlayer_2), frame_2);
}
...
void show_splash_screen(void) {
	...
	APP_LOG(APP_LOG_LEVEL_INFO, "Showing Splash...");
	splash_timer = app_timer_register(5000, app_timer_callback, NULL);
}
