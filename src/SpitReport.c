...
void initialise_ui(void) {
	...
	text_layer_set_text(spot_name_layer, "by A. Clymer");
	...
	text_layer_set_text(time_text_layer, "Version 0.76");
	...
	text_layer_set_text(swel_text_layer, "Swell: Loading...");
	...
	text_layer_set_text(wind_text_layer, "Wind: Loading...");
	...
	text_layer_set_text(tide_text_layer, "Tide: Loading...");
...
void init(void) {
	...
	for (int i = 0; i < 5; i++)		
		snd_cmds[i] = malloc(7 * sizeof(char));
